    ...
    for name, module in model.named_modules():
        if "qkv" in name and isinstance(module, CPLoraMerged):
            if init_fn == "CP":
                ...
                _, (model_Q, heads_Q, headdim_Q) = decomp.fit_transform(Q_weight)
                _, (model_K, heads_K, headdim_K) = decomp.fit_transform(K_weight)
                _, (model_V, heads_V, headdim_V) = decomp.fit_transform(V_weight)
