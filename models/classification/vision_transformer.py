...
Source https://github.com/huggingface/pytorch-image-models/blob/main/timm/models/vision_transformer.py"""

import logging
import math
from collections import OrderedDict
from functools import partial
from typing import Any, Dict, Callable, Optional, Set, Tuple, Union, List, Type
try:
...
from timm.layers import PatchEmbed, Mlp, DropPath, AttentionPoolLatent, RmsNorm, PatchDropout, SwiGLUPacked, trunc_normal_, lecun_normal_, resample_patch_embed, resample_abs_pos_embed, use_fused_attn, get_act_layer, get_norm_layer, LayerType
from timm.models._builder import build_model_with_cfg
# from timm.models._features import feature_take_inidices
from timm.models import _features
from timm.models._manipulate import named_apply, checkpoint_seq, adapt_input_conv
from timm.models._registry import generate_default_cfgs, register_model, register_model_deprecations

__all__ = ["VisionTransformer"] # model registy will add each entrypoint function to this
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        if setLora == 1:
            self.qkv = lora.MergedLinear(dim, dim * 3, r=8, enable_lora=[True, False, True], bias=qkv_bias)
        else:
...
register_model_deprecations(__name__, {
    'vit_base_patch16_224_in1k': 'vit_base_patch16_224.augreg_in1k'
})